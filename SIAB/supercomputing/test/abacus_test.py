...
class TestAbacus(unittest.TestCase):
    ...
    def test_STRU(self):
        dimer, natom = sia.structure_to_text(shape="dimer",
                               element="Si",
                               mass=28.085,
                               fpseudo="Si.pbe-n-kjpaw_psl.1.0.0.UPF",
                               lattice_constant=10.263,
        ...
        trimer, natom = sia.structure_to_text(shape="trimer",
                                element="Si",
                                mass=28.085,
                                fpseudo="Si.pbe-n-kjpaw_psl.1.0.0.UPF",
                                lattice_constant=10.263,
        ...
        tetramer, natom = sia.structure_to_text(shape="tetramer",
                                    element="Si",
                                    mass=28.085,
                                    fpseudo="Si.pbe-n-kjpaw_psl.1.0.0.UPF",
                                    lattice_constant=10.263,
    ...
    def test_INPUT(self):
        ...
        input = sia.dftparam_to_text(calculation_setting=user_settings, suffix="unittest")
        lines = input.split("\n")
    ...
    def test_read_INPUT(self):
        result = sia.parse_abacus_dftparam("./SIAB/test/support")
    ...
    def test_version_compare(self):
        self.assertTrue(sia.VersionCheck("0.1.0", "0.1.0"))
        self.assertTrue(sia.VersionCheck("0.1.0", "0.1.1"))
        self.assertTrue(sia.VersionCheck("0.1.0", "0.2.0"))
        self.assertTrue(sia.VersionCheck("0.1.0", "1.0.0"))
        self.assertFalse(sia.VersionCheck("0.1.0", "0.0.1"))
        self.assertFalse(sia.VersionCheck("0.1.0", "0.0.9"))
        self.assertFalse(sia.VersionCheck("0.1.0", "0.0.0"))
    ...
    def test_is_duplicate(self):
        ...
        self.assertTrue(
            sia.DuplicateCheck("/root/abacus-develop/orbital_generation/SIAB/interface/test/support/Si-trimer-2.6",
                             calculation_setting)
        )
        self.assertFalse(
            sia.DuplicateCheck("/root/abacus-develop/orbital_generation/SIAB/interface/test/support/Si-trimer-2.7",
                             calculation_setting)
        )
        calculation_setting = {
            "basis_type": "pw",
